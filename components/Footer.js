    ...
    <footer className="bg-navy-950 text-white/60">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4 mt-6">
              <a href="https://www.linkedin.com/company/amprimo-&-flury-abogados/" target="_blank" rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-8 h-8 border border-white/15 flex items-center justify-center hover:border-gold-500 hover:text-gold-400 transition-all duration-300">
          ...
          {/* Navegación */}
          <div>
            <h4 className="text-white text-xs uppercase tracking-widest font-semibold mb-6">El Estudio</h4>
          ...
          {/* Contacto */}
          <div>
            <h4 className="text-white text-xs uppercase tracking-widest font-semibold mb-6">Contacto</h4>
            <div className="space-y-5">
              <div>
                <p className="text-white/30 text-xs uppercase tracking-wider mb-1">Dirección</p>
              ...
              <div>
                <p className="text-white/30 text-xs uppercase tracking-wider mb-1">Teléfono</p>
                <a href="tel:+5112080130" className="text-white/55 text-sm hover:text-gold-400 transition-colors">
                  (01) 208 0130
                </a>
              </div>
              <div>
                <p className="text-white/30 text-xs uppercase tracking-wider mb-1">Correo</p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-white/25 text-xs">
            ...
            <a href="https://elarisdigitalsolutions.com" target="_blank" rel="noopener noreferrer"
              className="underline underline-offset-2 decoration-white/20 hover:text-white/45 hover:decoration-white/40 transition-colors duration-200">
              Elaris Digital Solutions
            </a>.
          </p>
          <div className="flex items-center gap-5">
            <Link href="/politica-de-datos" className="text-white/25 text-xs hover:text-white/50 transition-colors">Política de Datos</Link>
          </div>
        </div>
      </div>
    </footer>
