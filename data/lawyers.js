...
export const partners = [
  {
    ...
    education: 'Abogado por la Universidad de Lima, y especialista en Derecho Constitucional, Derecho Procesal, Arbitraje y Solución de Controversias. Con más de 30 años de práctica profesional, ha participado en procesos judiciales y arbitrales, como consultor y árbitro, en casi todas las áreas de derecho.',
    bio: 'Congresista de la República por el período 2001 a 2006, habiéndose desempeñado como Primer Vicepresidente del Congreso y Presidente de las Comisiones de Constitución, Reglamento y Acusaciones Constitucionales y Transportes, Comunicaciones, Vivienda y Construcción.\n\nIntegra la lista de árbitros del Centro de Arbitraje de la Cámara de Comercio de Lima, del Centro Internacional de Arbitraje de la Cámara de Comercio Americana del Perú (AMCHAM – PERÚ). Asimismo, ha participado como árbitro en arbitrajes de la Corte de Arbitraje de La Haya, la Cámara de Comercio Internacional (CCI), así como en los principales centros de arbitraje nacionales.\n\nMiembro de la Comisión de Ética de la CONMEBOL.',
  },
  {
    name: 'Hans Flury',
    role: 'Socio',
...
export const associates = [
  {
    ...
    speciality: 'Ambiental · Administrativo · Competencia',
    areas: ['Derecho Ambiental', 'Regulación de Servicios Públicos', 'Derecho Administrativo', 'Derecho de la Competencia'],
    email: 'aangulo@amprimoabogados.com',
    linkedin: 'https://www.linkedin.com/in/angulocarvalloana/',
    education: 'Abogada por la Pontificia Universidad Católica del Perú, con maestría en Derecho Administrativo Económico por la Universidad del Pacífico, y con estudios de especialización en Regulación de los Recursos Naturales en la Universidad Peruana de Ciencias Aplicadas.',
    bio: '',
  },
  {
  ...
  },
  {
    ...
    speciality: 'Procesal Civil · Constitucional · Societario',
    areas: ['Derecho Procesal', 'Derecho Societario', 'Derecho Constitucional', 'Derecho Laboral'],
    email: 'rnunez@amprimoabogados.com',
    linkedin: 'https://www.linkedin.com/in/rodolfo-n%C3%BA%C3%B1ez-robinson-b5065389/',
    education: 'Abogado por la Pontificia Universidad Católica del Perú con especialidad en Derecho Procesal. Ha asesorado a diversas empresas en la prevención de conflictos civiles, societarios, contractuales e inmobiliarios y tiene amplia experiencia en el desarrollo de complejas estrategias procesales en materia civil, societaria, constitucional, administrativa y laboral.',
    bio: 'Es autor de diversas publicaciones en libros y revistas en temas de arbitraje y Derecho Constitucional, así como conferencista nacional e internacional en las mismas materias.',
  },
  {
  ...
  },
  {
    ...
    role: 'Asociado',
    img: '/images/ALEJANDRO-RAMOS-1.webp',
    speciality: 'Civil Patrimonial · Comercial · Arbitraje',
    areas: ['Derecho Civil Patrimonial', 'Derecho Comercial', 'Derecho Procesal', 'Arbitraje'],
    email: 'aramos@amprimoabogados.com',
    linkedin: 'https://www.linkedin.com/in/alejandro-ramos-t%C3%A1mara-8a2b1a21a/',
    education: 'Alejandro es abogado titulado por la Universidad de Lima.',
    bio: 'Su ejercicio profesional abarca las áreas de Derecho Civil Patrimonial, Derecho Comercial, Derecho Procesal y Arbitraje. Su labor incluye, entre otros, la elaboración de informes legales de índole civil y comercial, así como la asesoría en la negociación y el diseño de contratos, con particular incidencia en el ámbito inmobiliario. Asimismo, su práctica comprende la prevención y resolución de conflictos.\n\nHa participado en la asesoría a diversas compañías nacionales y extranjeras en procesos judiciales y en arbitrajes nacionales e internacionales ante la CCI y el CIADI en controversias relacionadas a temas civiles, comerciales y con la industria eléctrica y de la construcción.\n\nEn el ámbito académico, desde el año 2020 se desempeña como Jefe de Prácticas de los cursos de Acto Jurídico y Contratos Típicos en la Universidad de Lima. Asimismo, fue Director General y Director de Edición de la Revista Advocatus y formó parte de la delegación que representó a la Universidad de Lima en la IX Competencia Internacional de Arbitraje, en la cual se obtuvo el tercer lugar en el rubro de mejor Memorial de Demanda.',
  },
  {
