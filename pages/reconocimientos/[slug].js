...
export default function RecognitionPage({ recognition }) {
  return (
    <>
      <Head>
        <title>{recognition.name} | Amprimo, Flury, Barboza &amp; Rodríguez Abogados</title>
        <meta name="description" content={`Reconocimiento de ${recognition.name} a Amprimo, Flury, Barboza & Rodríguez Abogados.`} />
